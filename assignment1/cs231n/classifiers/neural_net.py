...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    #dfc1_dW1  dfc1_db1
    dfc1_dW1 = X                                               # (N, D)
    dsoftmax_dW1 = dfc1_dW1.T.dot(dsoftmax_dfc1)               # (H, D)
    dsoftmax_db1 = np.sum(dsoftmax_dfc1, axis=0)               # (H,)
    
    #dfc2_dW2
    dfc2_dW2 = relu                                            # (N, H)
    dsoftmax_dW2 = dfc2_dW2.T.dot(dsoftmax_dfc2)               # (H, C)
    dsoftmax_db2 = np.sum(dsoftmax_dfc2, axis=0)               # (H,)
    
    grads['W1'] = dsoftmax_dW1 + 2 * reg * W1
    grads['b1'] = dsoftmax_db1
    grads['W2'] = dsoftmax_dW2 + 2 * reg * W2
