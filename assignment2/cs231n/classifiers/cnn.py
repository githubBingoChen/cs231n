...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, output_cache = affine_forward(affine_relu_out, W3, b3)                      
        ...
        dfc, dW3, db3  = affine_backward(doutput, output_cache)
        daffine_relu, dW2, db2 = affine_relu_backward(dfc, affine_relu_cache)
